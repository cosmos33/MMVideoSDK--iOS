...
- (UIImage *)flashImageWithFlashMode:(MDRecordCaptureFlashMode)flashMode targetLevelType:(MDUnifiedRecordLevelType)targetLevelType
{
    ...
    switch (flashMode) {
        ...
        case MDRecordCaptureFlashModeOn:
        {
...
//    if (!self.currentRightView.hasRedPointOfFilterView) {
//        [self.rightViewForNormal removeRedPointOfFilterView];
//        [self.rightViewForHigh removeRedPointOfFilterView];
//    }
//
//    if (!self.currentRightView.hasRedPointOfFaceDecorationView) {
//        [self.rightViewForNormal removeRedPointOfFaceDecorationView];
//        [self.rightViewForHigh removeRedPointOfFaceDecorationView];
//    }
//
//    if (!self.currentRightView.hasRedPointOfMusicView) {
//        [self.rightViewForNormal removeRedPointOfMusicView];
//        [self.rightViewForHigh removeRedPointOfMusicView];
//    }
//
//    if (!self.currentRightView.hasRedPointOfThinView) {
//        [self.rightViewForNormal removeRedPointOfThinView];
//        [self.rightViewForHigh removeRedPointOfThinView];
//    }
}
...
{
//    if ([identifier isEqualToString:kRecordTipOfFilter]) {
//        CGRect rect = [self.currentRightView absoluteFrameOfFilterView];
//        *point = CGPointMake(CGRectGetMinX(rect) + CGRectGetWidth(rect) / 2.0f, CGRectGetMaxY(rect) + 5);
//        *anchorOffSet = 200;
//        *anchorType = MUAt8AnchorTypeTop;
//
//    } else if ([identifier isEqualToString:kRecordTipOfFace]) {
//        CGRect rect = [self.currentRightView absoluteFrameOfFaceDecorationView];
//        *point = CGPointMake(CGRectGetMinX(rect) + CGRectGetWidth(rect) / 2.0f, CGRectGetMaxY(rect) + 5);
//        *anchorOffSet = 200;
//        *anchorType = MUAt8AnchorTypeTop;
//
//    } else if ([identifier isEqualToString:kRecordTipOfMusic] ) {
//        CGRect rect = [self.currentRightView absoluteFrameOfMusicView];
//        *point = CGPointMake(CGRectGetMinX(rect) + CGRectGetWidth(rect) / 2.0f, CGRectGetMaxY(rect) + 5);
//        *anchorOffSet = 200;
//        *anchorType = MUAt8AnchorTypeTop;
//    } else if ([identifier isEqualToString:kRecordTipOfThin]) {
//        CGRect rect = [self.currentRightView absoluteFrameOfThinView];
//        *point = CGPointMake(CGRectGetMinX(rect) + CGRectGetWidth(rect) / 2.0f, CGRectGetMaxY(rect) + 5);
//        *anchorOffSet = 200;
//        *anchorType = MUAt8AnchorTypeTop;
//    }
